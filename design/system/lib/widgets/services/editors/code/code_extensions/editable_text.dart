...
// ///
// /// To integrate the [CustomTextField] into a [Form] with other [FormField] widgets,
// /// consider using [TextFormField].
// ///
// /// {@template flutter.textfield.wantKeepAlive}
...
// ///
// /// {@tool dartpad}
// /// This example shows how to create a [CustomTextField] that will obscure input. The
...
// ///    [CustomTextField]. The [EditableText] widget is rarely used directly unless
// ///    you are implementing an entirely different design language, such as
// ///    Cupertino.
// ///  * <https://io/design/components/text-fields.html>
...
//   /// {@macro flutter.InputDecorator.textAlignVertical}
...
//   /// {@macro flutter.services.TextInputConfiguration.size32artDashesType}
//   final SmartDashesType smartDashesType;

//   /// {@macro flutter.services.TextInputConfiguration.size32artQuotesType}
...
//   /// {@template flutter.textfield.onTap}
...
//   /// "spinner" buttons that increment and decrement a value in the [CustomTextField]
...
//   ///
//   /// The [mouseCursor] is the only property of [CustomTextField] that controls the
...
//   /// {@macro flutter.clipBehavior}
//   ///
//   /// Defaults to [Clip.hardEdge].
//   final Clip clipBehavior;

//   /// {@template flutter.textfield.restorationId}
...
//   /// Default builder for [CustomTextField]'s spell check suggestions toolbar.
//   ///
...
//   ///    parameter for which this is the default value for [CustomTextField].
...
//       misspelledTextStyle: configuration.misspelledTextStyle ?? CustomTextField.materialMisspelledTextStyle,
//       spellCheckSuggestionsToolbarBuilder: configuration.spellCheckSuggestionsToolbarBuilder ?? CustomTextField.defaultSpellCheckSuggestionsToolbarBuilder,
//     );
//   }
...
// class _CustomTextFieldState extends State<CustomTextField> with RestorationMixin implements TextSelectionGestureDetectorBuilderDelegate, AutofillClient {
...
//   @override
//   GlobalKey<EditableTextState> get editableTextKey => widget.editableKey ?? GlobalKey();
...
//       case TargetPlatform.linux:
//       case TargetPlatform.windows:
//         spellCheckConfiguration = CustomTextField.inferAndroidSpellCheckConfiguration(
//           widget.spellCheckConfiguration,
//         );
//     }
...
//           smartDashesType: widget.size32artDashesType,
