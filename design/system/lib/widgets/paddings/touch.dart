...
class TouchTargetPadding extends SingleChildRenderObjectWidget {
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => RenderTouchTargetPadding(minSize);

  @override
  void updateRenderObject(BuildContext context, covariant RenderTouchTargetPadding renderObject) => renderObject.minSize = minSize;
}
